...
class JWT
{
    ...
    //使用HMAC生成信息摘要时所使用的密钥
    private static $key = 'usesomesillystringforkey';
    ...
    public static function verifyToken($Token)
    {
        ...
        //签名验证 if (self::signature($base64header . '.' . $base64payload, self::$key, $base64decodeheader['alg']) !== $sign) return false;
    ...
    private static function setPayload($payload)
    {
        ...
        self::$payload = array_merge($payload,[
            'iss'=>'admin', //该JWT的签发者
            'iat'=>time(), //签发时间
            'exp'=>time()+7200, //过期时间
